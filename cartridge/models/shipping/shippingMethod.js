...
var formatCurrency = require('*/cartridge/scripts/util/formatting')
  .formatCurrency
...
function getIsSelected(shippingMethod, shipment) {
  var selectedShippingMethod =
    shipment.shippingMethod || ShippingMgr.getDefaultShippingMethod()
  var selectedShippingMethodID = selectedShippingMethod
    ? selectedShippingMethod.ID
    : null

  return (
    selectedShippingMethodID && shippingMethod.ID === selectedShippingMethodID
  )
}
...
function ShippingMethodModel(shippingMethod, shipment) {
  ...
  this.estimatedArrivalTime =
    shippingMethod && shippingMethod.custom
