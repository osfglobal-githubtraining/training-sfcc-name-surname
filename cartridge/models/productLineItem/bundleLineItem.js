 ...
 */
module.exports = function productLineItem(
  product,
  apiProduct,
  options,
  factory
  ...
  productDecorators.price(
    product,
    apiProduct,
    options.promotions,
    false,
    options.currentOptionModel
  )
  ...
  productLineItemDecorators.quantityOptions(
    product,
    options.lineItem,
    options.quantity
  )

  productLineItemDecorators.bundledProductLineItems(
    product,
    options.lineItem,
    factory
  )
