...
function RegionModel(container, name) {
  ...
  this.defaultComponentRenderSettings = new ComponentRenderSettings().setTagName(
    'div'
  )
  this.regionRenderSettings.setDefaultComponentRenderSettings(
 ...
 * @return {RegionModel} The region model object
 */
RegionModel.prototype.setComponentTagName = function componentTagName(
  tagName,
  position
) {
 ...
 * @return {RegionModel} The region model object
 */
RegionModel.prototype.setComponentClassName = function setComponentClassName(
  cssClass,
  componentSelector
) {
 ...
 * @return {RegionModel} The region model object
 */
RegionModel.prototype.setComponentAttribute = function setComponentAttribute(
  name,
  value,
  componentSelector
) {
  ...
  if (typeof position === 'number') {
    ...
    renderSettings = this.regionRenderSettings.getComponentRenderSettings(
      component
    )
  }
  ...
  if (component) {
    this.regionRenderSettings.setComponentRenderSettings(
      component,
      renderSettings
    )
  }
