...
server.post(
  ...
  function (req, res, next) {
    ...
    // form validation
    if (
      newPasswords.newpassword.value !== newPasswords.newpasswordconfirm.value
    ) {
      profileForm.valid = false
    ...
    if (profileForm.valid) {
      ...
      this.on('route:BeforeComplete', function () {
        ...
        if (status.error) {
          if (
            !CustomerMgr.isAcceptablePassword(newPasswords.newpassword.value)
          ) {
...
server.post(
  ...
  function (req, res, next) {
    ...
    if (
      passwordForm.newpassword.value !== passwordForm.newpasswordconfirm.value
    ) {
