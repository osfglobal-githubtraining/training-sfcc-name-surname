...
function showControls($parentElement) {
  ...
  $carouselItems.each(function (index) {
    ...
    $parentElement
      .find('.pd-carousel-indicators li')
      .last()
...
function fillDomElement(einsteinResponse, $parentElement) {
  var recommendedProducts =
    einsteinResponse[$parentElement.data('recommender')].recs
...
function loadRecommendations() {
  ...
  if (einsteinUtils) {
    ...
    $recommendationTiles.each(function () {
      ...
      if (
        $(this).closest('.experience-einstein-einsteinCarouselProduct').length
      ) {
        return processRecommendationsTile(
          $parentElement,
          einsteinUtils,
          createProductAnchor($parentElement)
        )
      } else if (
        $(this).closest('.experience-einstein-einsteinCarouselCategory').length
      ) {
        return processRecommendationsTile(
          $parentElement,
          einsteinUtils,
